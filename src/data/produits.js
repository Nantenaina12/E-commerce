const products = [
  ...
  { 
    ...
    specs: [
      ...
      "Résolution: 1000 dpi",
      "Autonomie: 18 mois",
      "Connectivité: Nano récepteur USB",
  ...
  { 
    ...
    specs: [
      ...
      "Taux de sondage: 1000Hz",
      "Touches: 100% anti-ghosting"
    ]
  },
  { 
    id: 4,
  ...
  { 
    ...
    specs: [
      "Type: Circumaural",
      "Technologie: Son surround 7.1",
      "Micro: Détachable avec anti-bruit",
      "Compatibilité: Multiplateforme",
      "Longueur câble: 1m + extension 2m"
    ]
  },
  { 
    id: 6,
  ...
  { 
    ...
    specs: [
      "Capacité: 128 Go",
      "Interface: USB 3.1",
      "Vitesse lecture: Jusqu'à 150 Mo/s",
      "Compatibilité: USB 3.0/2.0",
      "Garantie: 5 ans"
    ]
  },
  { 
    ...
    specs: [
      ...
      "Bandes: Dual-band (2.4GHz + 5GHz)",
      "Débit: Jusqu'à 1.8 Gbps",
      "Ports: 4 LAN Gigabit, 1 WAN",
      "Sécurité: WPA3"
    ]
  },
  { 
  ...
  { 
    ...
    price: "119.90 MAD",
    specs: [
      "Ports: HDMI, 3x USB 3.0, Ethernet, USB-C",
      "Charge: Jusqu'à 65W",
      "Résolution: 4K@30Hz",
      "Compatibilité: Universelle USB-C",
